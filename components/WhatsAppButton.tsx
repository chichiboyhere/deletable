...
const WhatsAppButton = () => {
  const phoneNumber = "2347038223500";
  const message =
    "Hello Dcommando Security, I would like to make an inquiry about your services.";
  ...
  return (
    <Link
      ...
      className="fixed bottom-20 right-6 z-[999] group flex items-center gap-3"
    >
      {/* Tooltip */}
